            ...
            <div className="container text-center">
                <div className='row align-items-center'>
                    <div className='card-body col-lg-2 col-md-4 col-sm-4 m-3'>
                        <div id="carouselExampleControlsNoTouching4" class="carousel slide" data-bs-touch="false">
                        ...
                        <div className=' border'>
                            <h5 className='text-capitalize card-title m-4'>👰Wedding Shoots🤵</h5>
                            <Link className='btn btn-outline-primary card-btn  m-2' to='wedding'>Explore More</Link>
                        </div>
                    </div>
                </div>
            </div>
